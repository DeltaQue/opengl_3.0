...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// light properties
		lightingShader.setVec3("light.ambient", 0.1745f, 0.01175f, 0.01175f);
		lightingShader.setVec3("light.diffuse", 0.61424f, 0.04136f, 0.04136f);
		lightingShader.setVec3("light.specular", 0.727811f, 0.626959f, 0.626959f);
